      ...
      return (
        <div>
          ...
          <div className='itinerary-block-buttons'>
            <Link to={{pathname: '/bookit', state: {data: this.props.data, showndata: this.props.showndata, totalcost: this.props.totalcost, flightCost: this.props.flightCost,activitiesCost: this.props.activitiesCost, hotelCost: this.props.hotelCost }}}><div className='button'>Book Now</div></Link>

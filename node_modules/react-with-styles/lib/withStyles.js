        ...
        _createClass(WithStyles, [{
          ...
          value: function () {
            function maybeCreateStyles() {
              var direction = this.context[_constants.CHANNEL] && this.context[_constants.CHANNEL].getState();
              ...
              if (isRTL && !styleDefRTL) {
                ...
                styleDefLTR = styleFn ? _ThemedStyleSheet2['default'].create(styleFn) : EMPTY_STYLES_FN;
              }
